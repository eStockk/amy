  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <div class="actions">
        ...
        <button class="ghost" type="button">Посмотреть</button>
      </div>
    </div>
    <div class="hero-media">
      <div class="glow"></div>
      <img class="character" :src="logo" alt="Amy logo" />
    </div>
  </section>
</template>
...
.glow {
  ...
  height: 220px;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(240, 90, 60, 0.8), transparent 65%);
  filter: blur(10px);
